...
export default function AddPlotFormModel(props) {
    ...
    let [sellers, setSellers] = React.useState([])
    ...
    React.useEffect(() => {
        ...
        propertyServices.getSellers()
            .then(sellersData => {
                console.log("Raw sellers data received:", sellersData);
                setSellers(sellersData);
                console.log("Sellers state updated:", sellersData);
            })
            .catch(error => {
    ...
    const handleChange = (e) => {
        ...
        if (type === 'number') {
            // If value is negative or not a number, don't update
                            ...
                            <div className='d-flex justify-content-center'>
                                <form className='' onSubmit={handleSubmit} id="formID" enctype="multipart/form-data">
                                    <div className=''>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="form-group py-2 d-flex justify-content-between">
                                                <input type="number" className="form-control" onChange={handleChange} name="length" placeholder="Length" value={form.length} min="0" required />
                                                <input type="number" className="form-control" onChange={handleChange} name="width" placeholder="Width" value={form.width} min="0" required />
                                            </div>
                                        </div>

                                        <div className="form-group py-2">
                                            <label style={bottomMarginStyle}>Plot Size  </label>
                                            <input type="number" className="form-control" onChange={handleChange} name="size" placeholder="Marla" value={form.size} min="0" required />
                                        </div>
                                        ...
                                        <div className="form-group py-2">
                                            ...
                                            <input type="text" className="form-control" onChange={handleChange} name="price" placeholder="Price" value={form.price} min="0" required />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="form-group py-2 d-flex justify-content-between">
                                            <input type="text" className="form-control" onChange={handleChange} name="scheme" placeholder="Scheme" required value={form.scheme} />
                                        </div>
                                    ...
                                    <div>
                                        <h4 className='text-center text-light bg-dark my-3 py-2'>Seller Information</h4>
                                        
                                        <div className="form-group py-2">
                                            <label style={bottomMarginStyle}>Select Seller</label>
                                            {console.log("Rendering sellers dropdown with:", sellers)}
                                            <select 
                                            ...
                                            >
                                                ...
                                                {sellers && sellers.map(seller => (
                                                    <option key={seller._id} value={seller._id}>
                                                        {seller.name} - {seller.area} ({seller.contactInfo})
                                                    </option>
                                                ))}
                                            </select>
                                        </div>
